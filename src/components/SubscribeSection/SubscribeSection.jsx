...
const SubscribeSection = () => {
  return (
      ...
      <p className="text-2xl mb-12">Get Early Bird Deals, Extra Discounts & Priority Customer Support.</p>
      <div className="flex flex-col md:flex-row justify-center items-center gap-4">
        <input
          type="text"
          placeholder="First name"
          className="px-4 py-2 rounded-md border border-black w-60 h-14 focus:outline-none bg-[#F7E700]"
        />
        <input
          type="email"
