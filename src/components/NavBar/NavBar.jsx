  ...
  return (
    <>
      <nav className="w-full flex items-center justify-between p-4 bg-white border-b shadow-sm">
        ...
        <div className="flex items-center space-x-2 relative xs:-left-20">
          <img
            src="https://d31aoa0ehgvjdi.cloudfront.net//eyJidWNrZXQiOiJ0aGV0YXJ6YW53YXktd2ViIiwia2V5IjoibWVkaWEvd2Vic2l0ZS9sb2dvLW9ubHkuc3ZnIiwiZWRpdHMiOnsicmVzaXplIjp7ImZpdCI6ImNvdmVyIn19fQ=="
            alt="logo"
        ...
        <div className="flex items-center space-x-4 mr-0">
          <button
            className="bg-yellow-300 text-black hover:bg-black hover:text-white border border-black font-semibold py-2 px-4 rounded-md transition-all hidden md:block"
          >
            Create a Trip
          </button>
          ...
          <div
            onClick={handleOtpAuthClick}
            className="flex items-center bg-white border border-gray-300 p-2 rounded-full hover:bg-gray-100 cursor-pointer"
          >
            {/* User Icon */}
            <svg
