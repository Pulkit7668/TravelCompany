...
const TripPlannerGrid = () => {
  return (
      <div>
       <h1 className='text-4xl font-bold ml-40 mb-5'>Plan trip as per mood</h1>
       <div className="grid grid-cols-4 gap-3 p-4 w-[80vw] mx-auto">
         ...
         <div className="relative col-span-2 md:col-span-1 h-60 w-96">
           <img
         ...
         <div className="flex items-center justify-center h-60 w-52 ml-2 border border-black rounded-lg col-span-2 md:col-span-1 relative left-20 ">
           <div className="text-center">
             <h2 className="text-4xl font-bold">69k+</h2>
             <p className="text-lg font-semibold">Trips Planned so far.</p>
           </div>
         </div>

         {/* Volunteer Trip Planner (Bottom-right small image) */}
         <div className="relative col-span-4 md:col-span-2 h-80 bottom-20">
           <img
       ...
       <button className="bg-yellow-300 hover:bg-black text-black hover:text-white border border-black text-center transition-all font-semibold py-2 px-10 rounded-lg">Create your free itinerary</button>
       </div>
      </div>
  );
};
