...
function AndamanNicobarHomePage() {
  ...
  return (
    <header className="relative h-[60vh] xs:h-[60vh] sm:h-[70vh] md:h-[100vh] 3xl:h-[60vh] overflow-hidden">
      {/* Background Image */}
      <img
        src="https://d31aoa0ehgvjdi.cloudfront.net//eyJidWNrZXQiOiJ0aGV0YXJ6YW53YXktd2ViIiwia2V5IjoibWVkaWEvY2l0aWVzLzE1ODUzMDEwMTU0MzQ3NDg4ODgwMTU3NDcwNzAzMS5qcGciLCJlZGl0cyI6eyJyZXNpemUiOnsid2lkdGgiOjIyNDAsImhlaWdodCI6MTA0MCwiZml0IjoiY292ZXIifX19"
        alt="Background"
      ...
      <div className="relative flex items-center justify-between px-10 h-full">
        ...
        <div className="text-white md:space-y-6 absolute top-40 md:top-16 xs:top-28 xs:left-20 sm:left-28 md:left-24 left-32 text-center md:text-left">
          <h1 className="text-xl mb-5 xs:mb-2 font-bold sm:text-2xl md:text-5xl md:font-extrabold leading-tight">Srinagar Trip Planner</h1>
        ...
        <div className="bg-white bg-opacity-80 p-3 rounded-lg shadow-lg max-w-md absolute right-24 top-16 hidden lg:block">
          ...
          <input type="text" placeholder="Srinagar" className="w-full mb-4 p-3 border rounded-md focus:outline-none" />
      ...
      {/* Bottom Icons */}
      <div className="absolute bottom-48 mx-5 sm:bottom-52 sm:mx-10 md:bottom-40 md:left-32 xs:space-x-16 xs:bottom-24 flex space-x-24 text-white text-center">
...
export default AndamanNicobarHomePage;