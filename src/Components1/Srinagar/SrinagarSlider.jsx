...
function SrinagarSlider() {
  ...
  return (
    <div className='w-5/6 h-[600px] m-auto'>
      <h1 className='text-4xl font-bold ml-2'>Trips by our users to Srinagar</h1>
      <div className='mt-8'>
        <Slider  {...settings}>
          {data.map((d, index) => (
...
export default SrinagarSlider;


const data = [
    {
        route:`/jandk/srinagar/itinerary`,
