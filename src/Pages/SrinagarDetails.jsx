    ...
    <>
      ...
      <div className="p-8 min-h-screen">
        <div className="w-[100%] mx-auto rounded-lg">
          ...
          {/* Button */}
          <div className="px-6 py-4 md:flex md:items-center md:justify-between border-t">
            <div className="flex space-x-10 xs:space-x-2 xs:mb-5 xs:-ml-5">
              <button onClick={() => handleScrollToSection(briefRef)} className="text-gray-600 text-lg font-medium hover:border-yellow-400 hover:border-b-2 hover:text-yellow-400 hover:bg-[#262626] rounded-md px-4 py-1 transition-all duration-300 ease-in-out">
                Brief
              </button>
              <button onClick={() => handleScrollToSection(itineraryRef)} className="text-gray-600 text-lg font-medium hover:text-yellow-400 hover:border-b-2 hover:border-yellow-400 hover:bg-[#262626] rounded-md px-4 py-1 transition-all duration-300 ease-in-out">
                Itinerary
              </button>
              <button onClick={() => handleScrollToSection(staysRef)} className="text-gray-600 text-lg font-medium hover:text-yellow-400 hover:border-b-2 hover:border-yellow-400 hover:bg-[#262626] rounded-md px-4 py-1 transition-all duration-300 ease-in-out">
                Stays
              </button>
              <button onClick={() => handleScrollToSection(activitiesRef)} className="text-gray-600 text-lg font-medium hover:text-yellow-400 hover:border-b-2 hover:border-yellow-400 hover:bg-[#262626] rounded-md px-4 py-1 transition-all duration-300 ease-in-out">
                Activities
              </button>
            </div>
            <div>
              <button className="bg-yellow-300 text-black text-lg font-semibold py-2 px-4 xs:py-1 xs:ml-[25%] border border-black rounded-lg shadow-md hover:bg-black hover:text-white transition-all">
                Log in to proceed
              </button>
            </div>
          </div>
          ...
          {/* Route Section */}
          <div ref={briefRef} className="p-6">
